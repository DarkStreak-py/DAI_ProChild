...
public class Videos_Inserir extends Fragment {
    Uri downloadUri;
    ...
    DatabaseReference dataMateriais= database.getReference("Videos");
            ...
            while (iterator.hasNext()) {
                ...
                if(UtilizadorLigado.equals(nomebd)){
                    ...
                    if(tipobd.equals("Instituições")){
                        NavHostFragment.findNavController(Videos_Inserir.this)
                                .navigate(R.id.action_videos_Inserir_to_materiais_Inserir);
                    }
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.videos_inserir, container, false);
    }
